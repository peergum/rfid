 ...
 public:
  ...
  enum PCD_Register : byte {
    ...
    CollReg = 0x0E << 1,  // bit position of the first bit-collision detected on
                          // the RF interface
    //						  0x0F			// reserved for future
    //use

    // Page 1: Command
    // 						  0x10			// reserved for future
    // use
    ModeReg =
    ...
    // 						  0x1A			// reserved for future
    // use
    // 						  0x1B			// reserved for future
    // use
    MfTxReg =
    ...
    TestADCReg = 0x3B << 1      // shows the value of ADC I and Q channels
                                ...
                                // tests
                                // 						  0x3D			// reserved for production
                                // tests
                                // 						  0x3E			// reserved for production
                                // tests
  ...
  StatusCode checkResponse(byte waitIRq = 0);
  StatusCode processResponse();
